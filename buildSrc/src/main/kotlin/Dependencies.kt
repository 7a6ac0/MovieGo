object Dependencies {
    ...
    object AndroidX {
        ...
        const val legacy = "androidx.legacy:legacy-support-v4:${Versions.ArchitectureComponents.legacy}"
        const val lifecycleRuntime = "androidx.lifecycle:lifecycle-runtime-ktx:${Versions.ArchitectureComponents.lifecycle}"
        ...
        const val viewModelCompose = "androidx.lifecycle:lifecycle-viewmodel-compose:${Versions.ArchitectureComponents.lifecycle}"
